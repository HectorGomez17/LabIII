...
public class Calculadora extends JFrame {
	...
	private void calcularResultado() {
		if (operacion.equals("+")) 
                ...
                {
                    Double resultado1  = new Double(pantalla.getText());
                    resultado = Math.pow(resultado,resultado1);                    
                }                
                else if(operacion.equals("tan"))
                {
                    Double resultado1  = new Double(pantalla.getText());
                    resultado = Math.tan(resultado1);                    
                }
                else if(operacion.equals("cos"))
                {
                    Double resultado1  = new Double(pantalla.getText());
                    resultado = Math.cos(resultado1);                    
                }
                else if(operacion.equals("sen"))
                {
                    Double resultado1  = new Double(pantalla.getText());
                    resultado = Math.sin(resultado1);                    
                }
